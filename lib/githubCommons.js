...
exports.setupGitHubActionsForCDKDeployment =
  exports.createIAMUserForGitHubActions =
  exports.createIAMPolicyForGitHubActions =
    void 0;
...
const createIAMPolicyForGitHubActions = (construct) => {
  return (0, iamCommons_1.createIAMPolicy)(
    'GitHubActionsPolicy',
    'GitHubActionsPolicy',
    [
      'ec2:RunInstances',
    ...
    ['*'],
    aws_iam_1.Effect.ALLOW,
    commonConstants_1.STAGES.PROD,
    construct
  );
};
...
const createIAMUserForGitHubActions = (envName, construct) => {
  return (0, iamCommons_1.createIAMUser)(
    commonConstants_1.GITHUB_ACTIONS_IAM_USER,
    `${commonConstants_1.GITHUB_ACTIONS_IAM_USER}-${envName}`,
    construct
  );
};
...
const setupGitHubActionsForCDKDeployment = (envName, construct) => {
  ...
  return (0, iamCommons_1.createAccessKeyForUser)(
    ghUser,
    `${commonConstants_1.GITHUB_ACTIONS_ACTION_KEY}-${envName}`,
    construct
  );
};
