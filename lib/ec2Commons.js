...
exports.attachSSMPolicyToEC2Instance = exports.createAndAssignDefaultElasticIp = exports.createDefaultEc2Instance = exports.createDefaultSecurityGroup = exports.createDefaultVpc = void 0;
const ec2 = __importStar(require("aws-cdk-lib/aws-ec2"));
const iamCommons_1 = require("./iamCommons");
const commonConstants_1 = require("./commonConstants");
const createDefaultVpc = (vpcId, vpcName, maxAzs, construct, stage, isPublic = true) => {
...
const createDefaultSecurityGroup = (securityGroupId, securityGroupName, vpc, securityGroupDescription, stage, construct) => {
...
const createDefaultEc2Instance = (ec2InstanceId, ec2InstanceName, instanceType, machineImage, vpc, securityGroup, userDataContent, region, stage, construct) => {
...
const createAndAssignDefaultElasticIp = (eipName, ec2Instance, stage, construct) => {
...
const attachSSMPolicyToEC2Instance = (instance) => {
    (0, iamCommons_1.attachManagedPolicyToRole)(instance.role, commonConstants_1.MANAGED_POLICIES.SSM_MANAGED_INSTANCE_CORE);
};
