...
const createEventsTable = (entityName, construct) => {
    return new aws_cdk_lib_1.aws_dynamodb.TableV2(construct, entityName + 'Events', {
        tableName: entityName + 'Events',
        partitionKey: { name: 'entityId', type: aws_cdk_lib_1.aws_dynamodb.AttributeType.STRING },
        sortKey: { name: 'version', type: aws_cdk_lib_1.aws_dynamodb.AttributeType.NUMBER },
        ...
        billing: aws_cdk_lib_1.aws_dynamodb.Billing.provisioned({
            ...
            writeCapacity: aws_cdk_lib_1.aws_dynamodb.Capacity.autoscaled({ maxCapacity: 25 }),
        }),
...
const createSnapshotsTable = (entityName, construct) => {
    return new aws_cdk_lib_1.aws_dynamodb.TableV2(construct, entityName + 'Snapshots', {
